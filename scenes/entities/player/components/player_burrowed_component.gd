...
func physics_process(delta: float) -> void:
	...
	current_direction = current_direction.move_toward(last_input_vector, rotation_speed * delta)
		# current_direction = input_vector.normalized()
	velocity = velocity.move_toward(current_direction * move_speed, rotation_speed * delta)
